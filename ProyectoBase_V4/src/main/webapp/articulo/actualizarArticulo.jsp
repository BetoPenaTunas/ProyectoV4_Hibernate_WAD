            ...
            <form method="post" action="ArticuloServlet?accion=actualizarDatos">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="descripcion" id="b" placeholder="Ingrese el nuevo correo"
                           value="${dtoArt.descripcionArticulo}"
                           required>
