                        ...
                        <tr>
                            <td>
                                <!-- Para ver la info de cada REGISTRO de la base de datos 
                                 ...
                                 -->
                                <a href="ArticuloServlet?accion=ver&id=${dto.idArticulo}" class="btn btn-outline-success">
                            ...
                            <td>
                                ...
                                -->
                                <c:out value="${dto.nombreArticulo}" />
                            </td>
                            <td class="text-center">
                                <c:out value="${dto.idCategoria}" />
                            </td>
                            <td>
                                <c:out value="${dto.descripcionArticulo}" />
                            </td>
                            <td>
                                <a href="ArticuloServlet?accion=eliminar&id=${dto.idArticulo}" class="btn btn-outline-danger">Eliminar</a>
                            </td>
                            <td>
                                <a href="ArticuloServlet?accion=actualizar&id=${dto.idArticulo}" class="btn btn-outline-info">Actualizar</a>
                            </td>
                        </tr>
                        </c:forEach>
