                ...
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <c:out value="${dto.descripcionCategoria}" />
                            </td>
                            <td>
                                <a href="CategoriaServlet?accion=eliminar&id=${dto.idCategoria}" class="btn btn-outline-danger">Eliminar</a>
                            </td>
                            <td>
                                <a href="CategoriaServlet?accion=actualizar&id=${dto.idCategoria}" class="btn btn-outline-info">Actualizar</a>
                            </td>
                        </tr>
                        </c:forEach>
